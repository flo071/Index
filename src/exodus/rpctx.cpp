...
UniValue exodus_sendrawtx(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "5. referenceamount      (string, optional) a index amount that is sent to the receiver (minimal by default)\n"
            "\nResult:\n"
...
UniValue exodus_send(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 4 || params.size() > 6)
        throw runtime_error(
            ...
            "6. referenceamount      (string, optional) a index amount that is sent to the receiver (minimal by default)\n"
...
UniValue exodus_senddexsell(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 7)
        throw runtime_error(
            ...
            "4. amountdesired        (string, required) the amount of indexs desired\n"
...
UniValue exodus_sendissuancecrowdsale(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 14)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_sendissuancecrowdsale", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\" 2 1 0 \"Companies\" \"Index Mining\" \"Quantum Miner\" \"\" \"\" 2 \"100\" 1483228800 30 2")
            + HelpExampleRpc("exodus_sendissuancecrowdsale", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\", 2, 1, 0, \"Companies\", \"Index Mining\", \"Quantum Miner\", \"\", \"\", 2, \"100\", 1483228800, 30, 2")
        );
...
UniValue exodus_sendissuancefixed(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 10 || params.size() > 11)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_sendissuancefixed", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\" 2 1 0 \"Companies\" \"Index Mining\" \"Quantum Miner\" \"\" \"\" \"1000000\"")
            + HelpExampleRpc("exodus_sendissuancefixed", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\", 2, 1, 0, \"Companies\", \"Index Mining\", \"Quantum Miner\", \"\", \"\", \"1000000\"")
        );
...
UniValue exodus_sendissuancemanaged(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 9 || params.size() > 10)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("exodus_sendissuancemanaged", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\" 2 1 0 \"Companies\" \"Index Mining\" \"Quantum Miner\" \"\" \"\"")
            + HelpExampleRpc("exodus_sendissuancemanaged", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\", 2, 1, 0, \"Companies\", \"Index Mining\", \"Quantum Miner\", \"\", \"\"")
        );
...
UniValue exodus_sendspend(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 4) {
        throw std::runtime_error(
            ...
            "4. referenceamount              (string, optional) a index amount that is sent to the receiver (minimal by default)\n"
            "\nResult:\n"
            "\"hash\"                          (string) the hex-encoded transaction hash\n"
            "\nExamples:\n"
