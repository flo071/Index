...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_8_ZNODE_PAYMENT_ENFORCEMENT:    r = SPORK_8_ZNODE_PAYMENT_ENFORCEMENT_DEFAULT; break;
            case SPORK_9_SUPERBLOCKS_ENABLED:               r = SPORK_9_SUPERBLOCKS_ENABLED_DEFAULT; break;
            case SPORK_10_ZNODE_PAY_UPDATED_NODES:     r = SPORK_10_ZNODE_PAY_UPDATED_NODES_DEFAULT; break;
            ...
            case SPORK_15_POS_DISABLED:                     r = SPORK_15_POS_DISABLED_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_8_ZNODE_PAYMENT_ENFORCEMENT:    return SPORK_8_ZNODE_PAYMENT_ENFORCEMENT_DEFAULT;
        case SPORK_9_SUPERBLOCKS_ENABLED:               return SPORK_9_SUPERBLOCKS_ENABLED_DEFAULT;
        case SPORK_10_ZNODE_PAY_UPDATED_NODES:     return SPORK_10_ZNODE_PAY_UPDATED_NODES_DEFAULT;
        ...
        case SPORK_15_POS_DISABLED:                     return SPORK_15_POS_DISABLED_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_8_ZNODE_PAYMENT_ENFORCEMENT")    return SPORK_8_ZNODE_PAYMENT_ENFORCEMENT;
    if (strName == "SPORK_9_SUPERBLOCKS_ENABLED")               return SPORK_9_SUPERBLOCKS_ENABLED;
    if (strName == "SPORK_10_ZNODE_PAY_UPDATED_NODES")     return SPORK_10_ZNODE_PAY_UPDATED_NODES;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_8_ZNODE_PAYMENT_ENFORCEMENT:    return "SPORK_8_ZNODE_PAYMENT_ENFORCEMENT";
        case SPORK_9_SUPERBLOCKS_ENABLED:               return "SPORK_9_SUPERBLOCKS_ENABLED";
        case SPORK_10_ZNODE_PAY_UPDATED_NODES:     return "SPORK_10_ZNODE_PAY_UPDATED_NODES";
